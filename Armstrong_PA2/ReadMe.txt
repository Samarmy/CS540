...
python Armstrong_PA2.py <startState.txt> <goalState.txt>

It should print out the a list of actions from the startState to the goalState followed by the total number of steps and final state. 

If you want to change the startState or goalState you need to change the two input arguements after "python Armstrong_PA2.py " <startState.txt> <goalState.txt>